                                    ...
                                    <tr>
                                         <td rowspan="4"><b>Creation Publicity Pvt.Ltd.</b><br>4,Parekh-Vora Chambers<br>
                                                ...
                                                <tr class="item-row">
                                                    ...
                                                    <td><span class="per">Sq.Ft.</span></td>
                                                    <td><span class="amount">Rs1000</span></td>
                                                </tr>

                                               
                                                <tr id="hiderow">
                                                   <td colspan="6"><a id="addrow" href="javascript:;" title="Add a row">Add a row</a></td>
                                                   <td class="sum">Rs1000</td>

                                                </tr>
                                                

                                                <tr>
                                                    <td colspan="1">Add: &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp  SGST@9%</td>
                                                    <td></td>
                                                       <td></td>
                                                       <td></td>
                                                       <td></td>
                                                       <td></td>
                                                       <td class="tax">Rs90</td>
                                                </tr>
                                                
                                                <tr>
                                                    <td colspan="1">Add:  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp  CGST@9%</td>
                                                    <td></td>
                                                       <td></td>
                                                       <td></td>
                                                       <td></td>
                                                ...
                                                <tr>
                                                       ...
                                                       <td></td>
                                                       <td></td>
                                                        <td colspan="1"><input id="final" name="final" class='in' type='text' value="Rs.1180"></input></td>
                                                </tr>
                                                <tr>
                                                        <td colspan="7"><b>Amount Chargeble(in Words)<br>
                                                        <span id="word">One Thousand One Hundred Eighty</span></b></td>
                                                </tr>
                                                <tr>
                                                        <td rowspan="2" width="390">HSN/SAC</td>
                                                               ...
                                                               <tr>
                                                                   ...
                                                                   <td colspan="2" class="tax2">1000</td>
                                                                   <td>9%</td>
                                                                   <td class="tax1">180</td>
                                                                   <td>9%</td>
                                                                   <td class="tax1">180</td>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function() {
        ...
        function update_price() {
          ...
          var price = row.find('.rate').val() * row.find('.period').val()/30;
      ...
      function update_total() {
        ...
        var tax=Math.round(total*9/100);
          $('.tax').html("Rs"+tax);
          $('.tax1').html(tax);
          $('.tax2').html(2*tax);
