             ...
             <div class="modal-body">
              ...
              <div class="w3-row w3-section">
               ...
               <div class="w3-row w3-section">
                 ...
                 <div class="w3-col" style="width:50px"><i class="w3-xxlarge  fas fa-building"></i></div>
                  <div class="w3-rest">
                     <input type="text" class=" w3-input w3-border w3-round-xxlarge"  list="prev" name="prev_disp" placeholder="Previous Display" style="margin-bottom: 15px" autocomplete="off" required>
                    <datalist id="prev">
                      <?php
                     
                        $query = "select caption from display order by caption";
                        $results = $conn->query($query);
                  ...
                  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fas fa-university"></i></div>
                    <div class="w3-rest">
                      <select class=" w3-input w3-border w3-round-xxlarge" placeholder="Operation" id="operation" name='operation'>
                        <option value="Mount on top">Mount on top</option>
                ...
                <div class="w3-row w3-section">
                  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fas fa-calendar-alt"></i></div>
                    <div class="w3-rest">
                      <input  class=" w3-input w3-border w3-round-xxlarge" type="text" name="other_work" placeholder="other work">
                    </div>
                </div>
