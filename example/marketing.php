...
<body class="white-content">
  <div class="wrapper">
    ...
    <div class="main-panel">
      ...
      <div class="modal fade" id="avail" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
           <header class="w3-container w3-red w3-center ">
  <center><h1 class="w3-center">Select Date</h1></center>
                       </header>
        <div class="modal-content">
          
          <div class="modal-body">
               <form method='post' id="avails">
            <div class="w3-row w3-section">
  <div class="w3-col" style="width:50px;padding-top:40px"><i class="w3-xxlarge far fa-calendar-alt" style="color:blue;"></i></div>
    <div class="w3-rest">
...
<div class="w3-panel w3-card-4 w3-yellow">
  <label>From</label>
 <input  class="w3-input w3-border-0 w3-round-xxlarge" type="date" name="start">
   <br>
   </div>
</div>
   <div class="w3-half">
   <div class="w3-panel w3-card-4 w3-yellow">
  <label>To</label>
   <input  class="w3-input w3-border-0 w3-round-xxlarge" type="date" name="end" required>
   <br>
</div>
    </div>
    </div>
  ...
  <br>
<button style="width:50%" class="w3-button w3-red w3-round-xxlarge" id="available" >Submit</button>
<button style="width:50%" class="w3-button w3-green w3-round-xxlarge" id="imm" >Send</button>
<br>
<br>
</div>
        </div>
...
<datalist id="price">
  ...
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-id-card"></i></div>
          ...
          <div class="col-md-12">
            <div class="card ">
              <div class="card-header card-header-info">
                <h4 class="card-title text-center" style="color:white;"><b> LIST OF AVAILABLE SITES<label id="me"></label></b></h4>           
   ...
   <button id="btnSelectedRows" style="margin: 0px;" class="btn btn-outline-success" data-toggle="modal" data-target="#avail" >Available Sites</button>
   <button  style="margin: 0px;" class="btn btn-outline-success" id="allsites" >All Sites</button>
...
$(document).on('click','#allsites',function(e) {


$.ajax({
  type: "POST",
 
  url: '../attachments/all.php',
  success: function(data){
     
$.ajax({
  type: "POST",
   url: '../PHPMailer/mails.php',
  success: function(data){
      alert(data);
  }
...
$.ajax({
  type: "POST",
  data:$('#avails').serialize(),
  url: '../attachments/available.php',
  success: function(data){
      alert(data);
  }
});
