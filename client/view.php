...
<div class="w3-card-4">
  ...
  <form method='post' action="../client/display.php" >
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-user"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border w3-round-xxlarge" type="phone" name="c_id" placeholder="Client Id" >
    </div>
</div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-id-card"></i></div>
    <div class="w3-rest">
    <input class="w3-input w3-border w3-round-xxlarge" id="sect" list="sitee" id="cli_name" name="cli_name" placeholder="Select Client" style="margin-bottom:15px" autocomplete="off">
    <datalist id="sitee">
      <?php
